export const enStrings: Record<string, string> = {
  ...
  tab_votes: "Votes",
  tab_history: "Career & History",
  tab_sources: "Sources",
  history_title: "Parliamentary Career & Historical Terms",
  history_desc: "Chronological record of elected offices held across Senedd Cymru and UK Parliament.",
  history_no_terms: "No previous parliamentary terms on record. This is a newly elected member.",
  history_current_term: "Current Office",
  history_past_term: "Historical Term",
  history_first_elected: "First elected",
...
export const cyStrings: Partial<Record<string, string>> = {
  ...
  tab_history: "Gyrfa a Hanes",
  tab_sources: "Ffynonellau",
  history_title: "Gyrfa Seneddol a Thelerau Hanesyddol",
  history_desc: "Cofnod cronolegol o swyddi etholedig a ddelir ar draws Senedd Cymru a Senedd y DU.",
  history_no_terms: "Dim telerau seneddol blaenorol ar gofnod. Mae hwn yn aelod a etholwyd o'r newydd.",
  history_current_term: "Swydd Bresennol",
  history_past_term: "Tymor Hanesyddol",
  history_first_elected: "Etholwyd gyntaf",
