...
import DataAvailabilityPage from "./pages/DataAvailabilityPage";
    ...
    <div className="page-wrapper">
      <nav className="nav" ref={menuRef} style={{ position: "relative" }}>
        <div className="container">
          <div className="nav__inner">
            ...
            <div className="nav__links">
              ...
              <NavLink to="/data" className={({ isActive }) => `nav__link${isActive ? " active" : ""}`}>
                {t("nav_data")}
              </NavLink>
            </div>
        ...
        <div className={`nav__mobile-menu${menuOpen ? " open" : ""}`}>
          <NavLink to="/" end className={({ isActive }) => `nav__mobile-link${isActive ? " active" : ""}`}>
            {t("nav_home")}
          </NavLink>
          <NavLink to="/data" className={({ isActive }) => `nav__mobile-link${isActive ? " active" : ""}`}>
            {t("nav_data")}
          </NavLink>
      ...
      <main style={{ flex: 1 }}>
        <Routes>
          ...
          <Route path="/data" element={<DataAvailabilityPage />} />
        ...
        <div className="container">
          <div className="footer__inner">
            ...
            <div className="footer__links">
              <Link to="/data" className="footer__link">{t("nav_data")}</Link>
            </div>
          </div>
        </div>
      </footer>
